...
async def run():
    ...
    while 1:
        ...
        if v > maxSpeed:
            ...
            target_vx = target_vx * normFactor
            target_vy = target_vy * normFactor
            target_vz = target_vz * normFactor
...
async def get_position(drone,ref_lat,ref_long,ref_alt):
    async for position in drone.telemetry.position():
            drone_telemetry.qx, drone_telemetry.qy, drone_telemetry.qz = pm.geodetic2ned\
