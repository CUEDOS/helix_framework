...
class TestGtools(unittest.TestCase): # inherit from unittest.TestCase 
	def test_alt_calc (self):  # this is a method so it should start with test_ and then the function we want to test
		alt_dict={"P101":25, "P102":12.5, "P103":11, "P104":21, "P105":18, "P106":14} # altitude set 1
		alt_return_dict_1={"P101":12, "P102":10, "P103":16, "P104":14, "P105":20, "P106":18 } # correct dictionary for input set 1
