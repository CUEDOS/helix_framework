async def return_to_home(drone, home_lat, home_long, rtl_altitude, rtl_start_lat, rtl_start_long):
    ...
    while abs(current_lat - rtl_altitude) > 0.0001 or abs(current_long - home_long) > 0.0001 or abs(current_alt - rtl_altitude) > 0.05:  
