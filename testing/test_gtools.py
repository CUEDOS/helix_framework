...
class TestGtools(unittest.TestCase): # inherit from unittest.TestCase 
	...
	# input output set 6 -----------------------------------------------
		...
		self.assertEqual(alt_return_dict_6,alt_return_dict) # assessing outputs of set 6
	...
	# input output set 7 -----------------------------------------------
		...
		self.assertEqual(alt_return_dict_7,alt_return_dict) # assessing outputs of set 7
