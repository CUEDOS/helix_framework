from testing.test_gtools import alt_calc # importing the module we want to test its function (the test file should be in the same directory as module file)
