...
# Set1: even number of drones, Set2: even number of drones, two same altitudes, Set3: odd number of drones, Set4: odd number of drones, two same altitudes, Set5:8 drones, all same altitudes
@pytest.mark.parametrize('dict_in, dict_out',[
	...
	({"P101":20, "P102":15, "P103":21, "P104":20, "P105":14},{"P101":18, "P102":17, "P103":20, "P104":19, "P105":16}),
	({"P101":20, "P102":20, "P103":20, "P104":20, "P105":20, "P106":20, "P107":20, "P108":20},{"P101":16.5, "P102":17.5, "P103":18.5, "P104":19.5, "P105":20.5, "P106":21.5, "P107":22.5, "P108":23.5})
])
