...
for key in alt_return_dict_1.keys():
...
for key in alt_return_dict_2.keys():
...
for key in alt_return_dict_3.keys():
...
for key in alt_return_dict_4.keys():
...
for key in alt_return_dict_5.keys():
...
for key in alt_return_dict_6.keys():
...
for key in alt_return_dict_7.keys():
